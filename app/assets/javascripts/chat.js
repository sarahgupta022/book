    ...
    chatBox = {
        ...
        createChatBox: function (conversation_id, minimizeChatBox) {
            ...
            $.get("conversations/" + conversation_id, function (data) {
                ...
                $("#chatbox_" + conversation_id + " .chatboxcontext").scrollTop($("#chatbox_" + conversation_id + " .chatboxcontext")[0].scrollHeight);
            }, "html");
            ...
            if (minimizeChatBox == 1) {
                ...
                if (minimize == 1) {
                    $('#chatbox_' + conversation_id + ' .chatboxcontext').css('display', 'none');
            ...
            $("#chatbox_" + conversation_id).click(function () {
                if ($('#chatbox_' + conversation_id + ' .chatboxcontext').css('display') != 'none') {
                    $("#chatbox_" + conversation_id + " .chatboxtextarea").focus();
                }
            });
        ...
        toggleChatBoxGrowth: function (conversation_id) {
            if ($('#chatbox_' + conversation_id + ' .chatboxcontext').css('display') == 'none') {
                ...
                $('#chatbox_' + conversation_id + ' .chatboxcontext').css('display', 'block');
